<h3>常用的前端JavaScript方法封装</h3>
使用url: https://segmentfault.com/a/1190000039220666
-----

<h5>1、输入一个值，返回其数据类型</h5>
```js
function type(para) {
...
<h5>10、封装mychildren，解决浏览器的兼容问题</h5>
```js
...
<h5>22、兼容getElementsByClassName方法</h5>
```js
...
<h5>41、requestAnimFrame兼容性方法</h5>
```js
