 ...
 * @LastEditTime: 2021-10-16 15:44:34
-->
<template>
  <div class="major-wrap">
    ...
    <div class="major-contents">
      ...
      <div
        class="icon_heat_map"
        :class="[!leftShow && 'hide', isHeatMapWid && 'active']"
        title="人流热力图"
        @click="openHeatMap"
      >
        <svg
      ...
      <div
        class="icon_heat_map gas_station"
        :class="[!leftShow && 'hide']"
        title="加油站"
        @click="onGasStation"
      >
        ...
        >
          <path
            d="M174.545455 256m23.272727 0l465.454545 0q23.272727 0 23.272728 23.272727l0 93.090909q0 23.272727-23.272728 23.272728l-465.454545 0q-23.272727 0-23.272727-23.272728l0-93.090909q0-23.272727 23.272727-23.272727Z"
            fill="#d81e06"
            p-id="1918"
      ...
      <!-- 指挥中心 -->
      <div
        class="icon_heat_map command_center"
        :class="[!leftShow && 'hide']"
        title="指挥中心"
        @click="onCommandCenter"
      >
        <svg
          t="1634351611898"
          class="icon"
      ...
      <EmergencyEventChange @openPlan="openPlan()" v-show="leftShow" />
      <FourStatistics v-show="leftShow" />
    ...
    <div
      class="small-and-change"
      :class="[leftShow ? 'small-and-change-left' : 'small-height-change-left']"
      @click="hiddenShowLeftClick"
    >
      {{ leftShow ? "《" : "》" }}
    </div>
    <div
