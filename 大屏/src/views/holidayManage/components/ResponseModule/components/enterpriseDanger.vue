<!--
 * @Author: lx
 * @Date: 2021-06-22 20:14:56
 * @LastEditTime: 2021-06-23 12:21:48
 * @LastEditors: Please set LastEditors
 * @Description: 企业隐患信息
 * @FilePath: \big-screen-vue\src\views\holidayManage\components\ResponseModule\components\enterpriseDanger.vue
-->
<template>
  <div class="enterprise-danger">
    <public-title title="企业隐患信息统计"></public-title>
...
<script>
import PublicTitle from '@/views/holidayManage/public/components/publicTitle.vue'
...
export default {
  ...
  data() {
    return {
      ...
      orderData: [{ disc: '天河', total: '139114' }, { disc: '天河', total: '12414' }, { disc: '天河', total: '124214' }, { disc: '天河', total: '123' }, { disc: '天河', total: '1242' }, { disc: '天河', total: '141241414' }, { disc: '天河', total: '1242' }, { disc: '天河', total: '12456' }],
