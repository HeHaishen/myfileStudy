 ...
 * @LastEditTime: 2021-11-05 11:38:21
-->
<template>
  <div class="emergencies">
    ...
    <pop-up-layer 
     ...
     v-if="moreShow" :show="moreShow" @doClose="moreClose" opsition="pageCenter" title="突发事件-更多" ref="myPopUpLayer">
    ...
    <pop-up-layer
      class="big_pop_up_layer"
     v-if="detailShow" :show="detailShow" @doClose="detailClose" opsition="pageCenter" title="突发事件-详情" ref="myPopUpLayer">
