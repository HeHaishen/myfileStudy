 ...
 * @LastEditTime: 2021-11-11 23:26:28
-->
<!-- 通讯录 -->
<template>
  <div class="abs_box">
    <div class="head" v-if="absBtnList && absBtnList.length">
      <div
        class="btn"
    ...
    <div class="content">
      ...
      <div class="list_box" :class="[activeBtnKey != 1 && 'list_s']">
        <div class="in_select_users" v-if="sclectKey && sclectKey.legnth">
          <div
            class="user"
...
.abs_box {
  ...
  .head {
    ...
    overflow: hidden;
    color: white;
    border-bottom: 1vh * @h #1d355a solid;
  ...
  .content {
    width: 100%;
    overflow: hidden;
    height: calc((1024vh * @h) - (26vh * @h) - (70vh * @h));
    // overflow: auto;
    .tree {
      width: 380vw * @w;
      overflow: auto;
    ...
    .list_box {
      width: calc(100% - 380vw * @w);
      border-left: 1vh * @h #1d355a solid;
      float: left;
      height: calc((1024vh * @h) - (26vh * @h) - (70vh * @h));
      position: relative;
